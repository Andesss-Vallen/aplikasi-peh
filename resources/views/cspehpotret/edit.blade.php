...
@section('content')
    <div class="container">
        ...
        <form action="/cspehpotret/{{ $cspehpotret->id }}" method="POST">
            @method('PUT')
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nama_cspehpotret" name="nama_cspehpotret"
                        value="{{ old('nama_cspehpotret', $cspehpotret->nama_cspehpotret) }}" required>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nomor_hp" name="nomor_hp"
                        value="{{ old('nomor_hp', $cspehpotret->nama_cspehpotret) }}" required>
                </div>
            </div>
